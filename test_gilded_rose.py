...
def update_items_by_number_of_days(days,items):
...
class GildedRoseTest(unittest.TestCase):
    def test_quality_cannot_decrease_past_0(self):
        ...
        updated_items = update_items_by_number_of_days(5, items)
    ...
    def test_aged_brie(self):
        ...
        updated_items = update_items_by_number_of_days(3, items)

        self.assertEqual(4, updated_items[0].quality) 

    def test_sulfuras_doesnt_degrade(self):
        items = [Item("Sulfuras, Hand of Ragnaros", 0, 80)]
        updated_items = update_items_by_number_of_days(10, items)
    ...
    def test_backstage_passes_increase_in_quality_5_days_or_less(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 15, 20)]
        updated_items = update_items_by_number_of_days(13, items)

        self.assertEqual(44, updated_items[0].quality)

    def test_backstage_lose_quality_on_sellin_day(self):
        items = [Item("Backstage passes to a TAFKAL80ETC concert", 15, 20)]
        updated_items = update_items_by_number_of_days(16, items)
    ...
    def test_quality_of_an_item_is_always_below_50(self):
        items = [
            Item("Backstage passes to a TAFKAL80ETC concert", 70, 20),
            Item("Aged Brie", 70, 0),
            Item("Conjured Mana Cake", 70, 6)
        ]

        # give an extraordinary amount of days to make sure it has the chance to go over.
        updated_items = update_items_by_number_of_days(60, items)
